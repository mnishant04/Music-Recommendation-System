...
label_map = ['Anger', 'Happy', 'Sad','Suprise']
...
def emotion_detect():
	...
	cap.release()
	link= f"https://open.spotify.com/search/{info['singer']}%20{prediction}%20{info['language']}%20song"

	link1  = f"https://www.youtube.com/results?search_query={info['singer']}+{prediction}+{info['language']}+song"
